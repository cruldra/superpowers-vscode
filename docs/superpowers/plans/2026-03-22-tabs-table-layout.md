...
- [x] **Step 1: 添加 setPlanContentStatus 函数**
...
- [x] **Step 1: 添加 setPlanStatus 命令注册**
...
- [x] **Step 1: 重写 getSuperpowersPanelHtmlContent 函数**
...
- [x] **Step 1: 添加 setPlanStatus 消息处理**
...
- [x] **Step 1: 创建 webview 目录**

```bash
mkdir -p test/webview
```

- [x] **Step 2: 创建 html.test.ts**
...
- [x] Tab 切换正常工作
- [x] Specs 表格显示名称、日期、操作
- [x] Plans 表格显示名称、日期、进度、状态、操作
- [x] 状态徽章颜色使用深色背景
- [x] 点击状态徽章显示下拉菜单
- [x] 选择状态后文件正确更新
- [x] 点击名称或"打开"正确打开文件
